...
public final class ActivityDocumentReminderBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDocumentReminderBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
      @NonNull LinearLayout customDate, @NonNull LinearLayoutCompat dateLayout,
  ...
  @NonNull
  public static ActivityDocumentReminderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDocumentReminderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_document_reminder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDocumentReminderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDocumentReminderBinding((RelativeLayout) rootView, btnAppy, customDate,
          dateLayout, etSearchBar, llCustomDateRange, loadMore, midLayout, binding_progress,
          rvVehicles, binding_toolbar, tvCustom, tvEndDate, tvStartDate, tvToday, tvWeek,
          tvYesterday);
    }
