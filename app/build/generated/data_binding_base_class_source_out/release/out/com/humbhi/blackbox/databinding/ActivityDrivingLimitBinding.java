...
public final class ActivityDrivingLimitBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDrivingLimitBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  @NonNull
  public static ActivityDrivingLimitBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDrivingLimitBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_driving_limit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDrivingLimitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDrivingLimitBinding((RelativeLayout) rootView, btnAppy, customDate,
          llCustomDateRange, loadMore, binding_progressLayout, rvRecycler, binding_toolbar,
