...
public final class NoDrivingAdapterBinding implements ViewBinding {
  @NonNull
  ...
  private NoDrivingAdapterBinding(@NonNull LinearLayout rootView, @NonNull CardView cvLiveStatus,
  ...
  @NonNull
  public static NoDrivingAdapterBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NoDrivingAdapterBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.no_driving_adapter, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NoDrivingAdapterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NoDrivingAdapterBinding((LinearLayout) rootView, cvLiveStatus, tvDetails,
          tvDrivingCount, tvDrivingDuration, tvDrivingLimit, tvVehNum);
    }
