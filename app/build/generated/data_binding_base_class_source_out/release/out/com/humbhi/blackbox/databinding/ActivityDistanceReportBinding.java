...
public final class ActivityDistanceReportBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDistanceReportBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  @NonNull
  public static ActivityDistanceReportBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDistanceReportBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_distance_report, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDistanceReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDistanceReportBinding((RelativeLayout) rootView, btnAppy, customDate,
