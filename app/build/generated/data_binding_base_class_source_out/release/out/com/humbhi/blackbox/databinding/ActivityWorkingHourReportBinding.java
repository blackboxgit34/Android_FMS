...
public final class ActivityWorkingHourReportBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView rvWorkHour;
  ...
  private ActivityWorkingHourReportBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull LinearLayoutCompat midLayout, @NonNull RecyclerView rvWorkHour,
  ...
  @NonNull
  public static ActivityWorkingHourReportBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityWorkingHourReportBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_working_hour_report, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityWorkingHourReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvWorkHour;
      RecyclerView rvWorkHour = ViewBindings.findChildViewById(rootView, id);
      if (rvWorkHour == null) {
        break missingId;
      }
      ...
      return new ActivityWorkingHourReportBinding((RelativeLayout) rootView, btnAppy, customDate,
          etSearchBar, llCustomDateRange, binding_llCustomProgress, loadMore, midLayout, rvWorkHour,
