...
public final class ActivityOverspeedReportBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOverspeedReportBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  @NonNull
  public static ActivityOverspeedReportBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOverspeedReportBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_overspeed_report, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOverspeedReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOverspeedReportBinding((RelativeLayout) rootView, btnAppy, customDate,
          etSearchBar, llCustomDateRange, loadMore, midLayout, binding_progressLayout, rvRecycler,
