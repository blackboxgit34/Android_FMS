...
public final class ActivityNoDrivingReportBinding implements ViewBinding {
  ...
  private ActivityNoDrivingReportBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  public static ActivityNoDrivingReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNoDrivingReportBinding((RelativeLayout) rootView, btnAppy, customDate,
