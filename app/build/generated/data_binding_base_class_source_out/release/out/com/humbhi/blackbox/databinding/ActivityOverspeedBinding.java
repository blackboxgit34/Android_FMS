...
public final class ActivityOverspeedBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOverspeedBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityOverspeedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityOverspeedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_overspeed, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOverspeedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOverspeedBinding((RelativeLayout) rootView, etSearchBar,
          binding_llCustomDateRange, loadMore, binding_progress, rvRecycler, binding_toolbar,
          tvCustom, tvToday, tvTotalCount, tvWeek, tvYesterday);
    }
