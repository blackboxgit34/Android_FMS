...
public final class NotificationBannerBinding implements ViewBinding {
  ...
  private NotificationBannerBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static NotificationBannerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NotificationBannerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.notification_banner, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NotificationBannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NotificationBannerBinding((RelativeLayout) rootView, notificationImage,
