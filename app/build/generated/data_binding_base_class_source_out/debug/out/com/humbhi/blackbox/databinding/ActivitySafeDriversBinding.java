...
public final class ActivitySafeDriversBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySafeDriversBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  @NonNull
  public static ActivitySafeDriversBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySafeDriversBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_safe_drivers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySafeDriversBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySafeDriversBinding((RelativeLayout) rootView, btnAppy, customDate,
          etSearchBar, llCustomDateRange, loadMore, rvRecycler, binding_toolbar, tvCustom,
          tvEndDate, tvStartDate, tvToday, tvWeek, tvYesterday);
    }
