...
public final class MapLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvAutocomplte;

  private MapLayoutBinding(@NonNull TextView rootView, @NonNull TextView tvAutocomplte) {
    this.rootView = rootView;
    this.tvAutocomplte = tvAutocomplte;
  }
  ...
  public static MapLayoutBinding bind(@NonNull View rootView) {
    ...
    TextView tvAutocomplte = (TextView) rootView;

    return new MapLayoutBinding((TextView) rootView, tvAutocomplte);
  }
}
