...
public final class ActivityOverstoppageReportActivtiyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityOverstoppageReportActivtiyBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView tvToday, @NonNull TextView tvWeek, @NonNull TextView tvYesterday) {
  ...
  @NonNull
  public static ActivityOverstoppageReportActivtiyBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ActivityOverstoppageReportActivtiyBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.activity_overstoppage_report_activtiy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityOverstoppageReportActivtiyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOverstoppageReportActivtiyBinding((RelativeLayout) rootView, btnAppy,
          customDate, etSearchBar, llCustomDateRange, loadMore, binding_progressLayout, rvRecycler,
