...
public final class ActivityFuelTheftReportBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView rvFuelTheft;
  ...
  @NonNull
  public static ActivityFuelTheftReportBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFuelTheftReportBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fuel_theft_report, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFuelTheftReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvFuelTheft;
      RecyclerView rvFuelTheft = ViewBindings.findChildViewById(rootView, id);
      if (rvFuelTheft == null) {
        break missingId;
      }
