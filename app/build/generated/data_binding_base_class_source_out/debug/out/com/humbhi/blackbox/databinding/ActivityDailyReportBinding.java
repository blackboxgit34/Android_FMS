...
public final class ActivityDailyReportBinding implements ViewBinding {
  ...
  private ActivityDailyReportBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
  ...
  public static ActivityDailyReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDailyReportBinding((RelativeLayout) rootView, btnAppy, customDate,
