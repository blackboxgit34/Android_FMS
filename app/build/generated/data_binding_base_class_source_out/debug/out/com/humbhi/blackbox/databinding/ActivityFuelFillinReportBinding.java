...
public final class ActivityFuelFillinReportBinding implements ViewBinding {
  ...
  private ActivityFuelFillinReportBinding(@NonNull RelativeLayout rootView, @NonNull Button btnAppy,
      ...
      @NonNull TextView loadMore, @NonNull RecyclerView rvFuelFilling,
  ...
  public static ActivityFuelFillinReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFuelFillinReportBinding((RelativeLayout) rootView, btnAppy, customDate,
          etSearchBar, llCustomDateRange, binding_llCustomProgress, loadMore, rvFuelFilling,
