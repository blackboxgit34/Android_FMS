...
public final class ActivityVehicleManagementBinding implements ViewBinding {
  ...
  private ActivityVehicleManagementBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull LinearLayoutCompat midLayout, @NonNull RecyclerView rvVehicles,
  ...
  @NonNull
  public static ActivityVehicleManagementBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVehicleManagementBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_vehicle_management, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVehicleManagementBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVehicleManagementBinding((RelativeLayout) rootView, btnAppy, customDate,
          dateLayout, etSearchBar, llCustomDateRange, loadMore, midLayout, rvVehicles,
