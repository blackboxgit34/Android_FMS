...
public final class ActivityWorkingHourReportBinding implements ViewBinding {
  ...
  public static ActivityWorkingHourReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWorkingHourReportBinding((RelativeLayout) rootView, etSearchBar,
          binding_llCustomDateRange, binding_llCustomProgress, loadMore, midLayout, rvWorkHour,
