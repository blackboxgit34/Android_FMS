...
public final class ActivityDrivingRouteInitialBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityDrivingRouteInitialBinding(@NonNull LinearLayoutCompat rootView,
  ...
  @NonNull
  public static ActivityDrivingRouteInitialBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDrivingRouteInitialBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_driving_route_initial, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDrivingRouteInitialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDrivingRouteInitialBinding((LinearLayoutCompat) rootView, bt24Hour,
