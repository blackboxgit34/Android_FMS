...
class ManageGeofenceAdapter(val context: Context) :
    RecyclerView.Adapter<ManageGeofenceAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.manage_geofence_adapter, parent, false)
