...
class StoppageReportActivity : AppCompatActivity(), StoppageReportView, View.OnClickListener {
    ...
    var limit = 20
    var totalRecords = 0
    var list : ArrayList<StoppageData> = ArrayList()
    ...
    override fun getStoppageReportResponse(stoppageReportResponseModel: StoppageReportResponseModel) {
        ...
        adapter = StoppageReportAdapter(this,list)
