...
class RashTurnChartAdapter(val context: Context, val listData: List<RashTurnData>) :
    RecyclerView.Adapter<RashTurnChartAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.rash_turn_chart_adapter, parent, false)
