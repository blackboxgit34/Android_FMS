...
import com.humbhi.blackbox.databinding.NewScoreCardLayoutBinding
import com.humbhi.blackbox.ui.data.models.AaData

class Top10ScoreCardAdapter(val context: Context, val listData: List<AaData>) :
    RecyclerView.Adapter<Top10ScoreCardAdapter.MyHolder>() {


    // Holds the views for adding it to image and text
    class MyHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(context: Context, list: List<AaData>) {
            NewScoreCardLayoutBinding.bind(itemView).apply {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.new_score_card_layout, parent, false)
