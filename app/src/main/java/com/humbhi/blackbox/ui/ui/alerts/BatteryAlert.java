...
public class BatteryAlert extends AppCompatActivity implements RetrofitResponse {
    ...
    private void setAlert(String bbid,String vehicleId)
    {
        ...
        new Retrofit2(this, this, Constants.REQ_SET_IGNITION_ALERT
                ,Constants.SET_IGNITION_ALERT+"bbid="+bbid+"&VehicleId="+vehicleId+"&messagetype=4&AlertStatus="+alertStatus+"&custid="
        ...
        switch (requestCode)
        {
            case Constants.REQ_GET_ALLVEHICLES_ALERTS:
                try
                {
                    ...
                    {
                        if (list.get(j).getBatteryDisconnection().equals("false"))
                        {
