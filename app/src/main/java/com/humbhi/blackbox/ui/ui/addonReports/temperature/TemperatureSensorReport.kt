...
class TemperatureSensorReport : AppCompatActivity(), TempSensorView,View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPresenter = TempSensorPresenterImpl(this, DataManagerImpl(RestClient.getRetrofitBuilderForTrackMaster()))
